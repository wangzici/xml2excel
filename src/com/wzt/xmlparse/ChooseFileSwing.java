...
public class ChooseFileSwing {
	...
	private static void createAndShowGUI() {
        ...
        panel.add(resButton);
        resButton.addMouseListener(new ShowDialogLintener(frame,userText,true));
        ...
        xlsDirButton.addMouseListener(new ShowDialogLintener(frame,xlsDirText,true));
        ...
        panel.add(xlsButton);
        xlsButton.addMouseListener(new ShowDialogLintener(frame,xlsText,false));
        ...
        resDirButton.addMouseListener(new ShowDialogLintener(frame,resDirText,true));
	...
	static class ShowDialogLintener extends MouseAdapter{  
	    ...
	    JTextField userText;
	    boolean isDirectory;
	    public ShowDialogLintener(JFrame frame,JTextField userText,boolean isDirectory) {  
	        this.frame = frame;  
